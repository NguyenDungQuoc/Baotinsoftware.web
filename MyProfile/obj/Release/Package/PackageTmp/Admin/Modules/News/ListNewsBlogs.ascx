<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListNewsBlogs.ascx.cs" Inherits="MyProfile.Admin.Modules.News.ListNewsBlogs" %>
        ...
        <div class='box box-info'>
            <div class='box-header no-padding-bottom'>
                ...
                <div class="pull-right box-tools">
                    ...
                    <a href="/Admin/editnews.aspx" class="btn btn-success btn-flat marginLeft-10" title="Thêm mới">
                ...
                <asp:GridView ID="GridView_ListData" runat="server" AutoGenerateColumns="False" Width="100%" HeaderStyle-Height="30px" OnRowCommand="GridView_ListData_OnRowCommand"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Tiêu đề">
                            <ItemTemplate>
                                <a target="blank" title="<%# Eval("Title") %>" href="<%# Eval("ID","/Admin/editnews.aspx?id={0}") %>"><%# Eval("Title") %></a>                                                                
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Thể loại">
                            <ItemTemplate>                                    
                                 <asp:DropDownList ID="ddl_GroupNews" Font-Size="13px" DataTextField="Name" DataValueField="ID" CssClass="form-control" runat="server" Enabled="false">                                                                
                                </asp:DropDownList>
                                <asp:HiddenField ID="hdf_GroupNews" runat="server" Value='<%# Eval("ID_GroupNews") %>'/>                           
                            </ItemTemplate>
