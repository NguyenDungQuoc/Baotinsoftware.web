<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListGroupServices.ascx.cs" Inherits="MyProfile.Admin.Modules.Services.ListGroupServices" %>
        ...
        <form action="#" method="post">
            <div class="modal-body">
                ...
                <div class="form-group row-horizontal">
                    ...
                    <div class="col-sm-9">                        
                        <textarea id="txtDescription" class="form-control" rows="3" placeholder="Enter..."></textarea>                        
                    </div>
                </div>                                
                <%--<div class="form-group row-horizontal">
...
<script type="text/javascript" src="/Theme/javascript/js_adminGroupServices.js"></script>