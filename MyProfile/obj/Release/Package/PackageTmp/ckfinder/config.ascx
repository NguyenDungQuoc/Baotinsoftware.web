...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png", "doc", "docx", "pdf", "xls", "xlsx" };
        type.DeniedExtensions = new string[] { };
        ...
        type = ResourceType.Add("OfficeFile");
        type.Url = BaseUrl + "images/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "doc/";
        type.MaxSize = 10485760;
        type.AllowedExtensions = new string[] { "doc", "docx", "pdf", "xls", "xlsx" };
        type.DeniedExtensions = new string[] { };
    }
